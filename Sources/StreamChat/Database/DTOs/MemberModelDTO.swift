...
extension _ChatChannelMember {
    fileprivate static func create(fromDTO dto: MemberDTO) -> _ChatChannelMember {
        ...
        return _ChatChannelMember(
            ...
            userRole: dto.user.userRoleRaw.isEmpty ? .user : UserRole(rawValue: dto.user.userRoleRaw)!,
            userCreatedAt: dto.user == nil ? Date() : dto.user.userCreatedAt,
            userUpdatedAt: dto.user == nil ? Date() : dto.user.userUpdatedAt,
            lastActiveAt: dto.user == nil ? Date() : dto.user.lastActivityAt,
